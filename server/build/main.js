...
/*global exports*/
var SignStream = __webpack_require__(41);
...
var _bcryptjs = __webpack_require__(35);
...
exports.ADMIN = exports.USER = undefined;
...
var JsonWebTokenError = __webpack_require__(5);
...
var _cors = __webpack_require__(59);
...
var _articles = __webpack_require__(27);
...
Object.defineProperty(exports, "articleRouter", {
  enumerable: true,
  get: function get() {
    return _articles.articleRouter;
  }
});
...
var _articles3 = __webpack_require__(34);
...
exports.default = {
  create: function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee(req, res) {
      var _articlesService$vali, value, error, article;
      ...
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _articlesService$vali = _articles4.default.valideArticleSchema(req.body), value = _articlesService$vali.value, error = _articlesService$vali.error;
            ...
            case 4:
              _context.next = 6;
              return _articles2.default.create({
                titre: value.titre,
                author: value.author,
                text: value.text,
                date: value.date
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 5;
              return _articles2.default.paginate({}, options);
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              id = req.params.id;
              _context3.next = 4;
              return _articles2.default.findById(id).populate('article', 'titre text');
            ...
            case 4:
              ...
              return _context3.abrupt('return', res.status(404).json({ err: 'could not find this article' }));
  ...
  update: function () {
    var _ref4 = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee4(req, res) {
      var id, schema, _Joi$validate, value, error, article;
      ...
      return _regenerator2.default.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 6:
              _context4.next = 8;
              return _articles2.default.findOneAndUpdate({ _id: id }, value, { new: true });
            ...
            case 8:
              ...
              return _context4.abrupt('return', res.status(404).json({ err: 'could not find the article' }));
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              id = req.params.id;
              _context5.next = 4;
              return _articles2.default.findOneAndRemove({ _id: id });
            ...
            case 4:
              ...
              return _context5.abrupt('return', res.status(404).json({ err: 'could not find the article' }));
...
var _mongoosePaginate = __webpack_require__(33);
...
exports.default = {
    valideArticleSchema: function valideArticleSchema(body) {
        var schema = _joi2.default.object().keys({
            titre: _joi2.default.string().required(),
            text: _joi2.default.string().required(),
...
userRouter.get("/me", _passport2.default.authenticate("jwt", { session: false }), _user2.default.authenticated);
...
var _jwt = __webpack_require__(39);
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
                while (1) {
                    switch (_context.prev = _context.next) {
                        case 0:
                            _context.prev = 0;
                            _userService$validate = _user4.default.validateSignUp(req.body), _value = _userService$validate.value, error = _userService$validate.error;
                        ...
                        case 4:
                            encryptedPass = _user4.default.encryptPassword(_value.password);
                            _context.next = 7;
                            return _user2.default.create({
                                ...
                                role: _value.role || _user.USER

                            });

                        case 7:
                            user = _context.sent;
                            return _context.abrupt("return", res.json({ succes: true }));
            ...
            return _regenerator2.default.wrap(function _callee2$(_context2) {
                while (1) {
                    switch (_context2.prev = _context2.next) {
                        case 0:
                            _context2.prev = 0;
                            _userService$validate2 = _user4.default.validateLogin(req.body), _value2 = _userService$validate2.value, error = _userService$validate2.error;
                        ...
                        case 4:
                            _context2.next = 6;
                            return _user2.default.findOne({ email: _value2.email });
                        ...
                        case 9:
                            authenticated = _user4.default.comparePassword(_value2.password, user.password);
...
var _development = __webpack_require__(21);
...
module.exports = {
  decode: __webpack_require__(14),
  verify: __webpack_require__(47),
  sign: __webpack_require__(49),
  JsonWebTokenError: __webpack_require__(5),
  NotBeforeError: __webpack_require__(18),
  TokenExpiredError: __webpack_require__(19),
};
...
/*global module*/
var Buffer = __webpack_require__(0).Buffer;
var DataStream = __webpack_require__(15);
var jwa = __webpack_require__(16);
var Stream = __webpack_require__(9);
...
var JsonWebTokenError = __webpack_require__(5);
var NotBeforeError    = __webpack_require__(18);
var TokenExpiredError = __webpack_require__(19);
var decode            = __webpack_require__(14);
var timespan          = __webpack_require__(20);
var jws               = __webpack_require__(8);
...
var _passportJwt = __webpack_require__(58);
